...
class Message:
    ...
    def set_headers(self, value: list[tuple[str, str | bytes]]) -> None: ...
    def set_key(self, value: str | bytes) -> None: ...
    def set_value(self, value: str | bytes) -> None: ...
...
class Consumer:
    ...
    def list_topics(self, topics: str | None = None, timeout: float | int = -1) -> ClusterMetadata: ...
    def memberid(self) -> str | None: ...
    def offsets_for_times(
        self, partitions: list[TopicPartition], timeout: float | int | None = None
    ) -> list[TopicPartition]: ...
    def pause(self, partitions: list[TopicPartition]) -> None: ...
    def poll(self, timeout: float | int | None) -> Message | None: ...
